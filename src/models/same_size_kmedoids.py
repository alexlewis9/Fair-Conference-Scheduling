"""
Modified from https://github.com/omaraflak/kmedoids

This version of KMedoids gives equally sized clusters (will not be optimal).

Instead of looping through the data points and assigning them to the nearest medoid, loop through 
the medoids and assign the nearest point to it.
"""
import random
import numpy as np
